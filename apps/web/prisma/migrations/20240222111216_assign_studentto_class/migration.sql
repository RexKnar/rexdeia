...
CREATE TABLE "StudentMapping" (
    ...
    CONSTRAINT "StudentMapping_pkey" PRIMARY KEY ("studentId","classId","groupId")
);

-- AddForeignKey
ALTER TABLE "Student" ADD CONSTRAINT "Student_sectionId_fkey" FOREIGN KEY ("sectionId") REFERENCES "Section"("_id") ON DELETE RESTRICT ON UPDATE CASCADE;
