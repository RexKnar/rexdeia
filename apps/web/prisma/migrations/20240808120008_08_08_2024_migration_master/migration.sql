...
-- CreateEnum
CREATE TYPE "StudentStatus" AS ENUM ('Pending', 'Rejected', 'Active', 'Discontinued', 'Transfered');
...
-- AddForeignKey
ALTER TABLE "Class" ADD CONSTRAINT "Class_classLevelId_fkey" FOREIGN KEY ("classLevelId") REFERENCES "ClassLevel"("_id") ON DELETE SET NULL ON UPDATE CASCADE;
