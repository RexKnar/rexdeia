...
import { EXAM_SUBJECT_MASTER_BY_CLASS_SECTION_EXAM_ID } from 'lib/endpoints/examAnalyticsEndpoints';
...
function getExamSubjectMasterByClassSectionId(
...
export function useGetExamSubjectMasterByClassSectionIdQuery(
  { examId, classId, sectionId }: getSubjectInputModel,
  options?: Partial<UseQueryOptions<any[]>>
) {
  return useQuery(
    getExamSubjectMasterByClassSectionId(
