...
import {
  getAllStudentByClassIdForAssigning,
...
export async function GET(request: Request, { params: { id } }) {
  ...
  try {
    const sections = await getAllStudentsByClassId(id);
 ...
 *   /api/class/{id}/students:
 *     post:
 *       summary: map students to a class
 ...
 *       responses:
 *         '200':
 *           description: Successfully mapped students to a class
 *           content:
 *             application/json:
 *               schema:
 *                 type: array
 ...
 * /api/class/{id}/students:
 *     put:
 *       summary: Get All Students in a class for assigning
 *       description: Get All Students in a class for assigning
 *       parameters:
 *         - name: id
 *           in: path
 *           required: true
