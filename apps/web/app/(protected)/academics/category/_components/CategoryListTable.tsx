...
export function CategoryListTable() {
  ...
  const { data: categoryListResponse, isLoading: isCategoryListLoading } =
    useGetCategoryList({
      page,
      limit,
    });
  ...
  } = useDeleteCategoryMutationQuery(page, limit);
            ...
            {table.getRowModel().rows?.length ? (
              ...
              <TableRow>
                <TableCell colSpan={5} className="h-24 text-center">
                  {isCategoryListLoading ? 'Loading...' : 'No Category Found'}
                </TableCell>
              </TableRow>
            )}
          </TableBody>
