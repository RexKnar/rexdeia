    ...
    XLSX_utils.sheet_add_aoa(
      ...
      [
        [
          ...
          `${row.pendingMarkEntry.overall} `,
          ` ${row.pendingMarkEntry.male} `,
          ` ${row.pendingMarkEntry.female}`,
          `${row.appeared.overall} `,
          ` ${row.appeared.male} `,
          ` ${row.appeared.female}`,
          `${row.absent.overall} `,
          ` ${row.absent.male} `,
          ...
          `${row.averageMarkAppeared.overall.toFixed(2)} `,
          ` ${row.averageMarkAppeared.male.toFixed(2)} `,
          ` ${row.averageMarkAppeared.female.toFixed(2)}`,
